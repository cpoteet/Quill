...
## Test suite status (2026-08-08 — 334 Swift + 239 JS tests, all passing)

Counts verified by running each suite on 2026-08-08; the previous header under-reported passthrough (13 → 22) and transforms (140 → 141). If you touch a suite, re-run it and correct the number rather than trusting the prose below.
