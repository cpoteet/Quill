...
## Test suite status (2026-06-07 — 211 Swift + 52 JS tests, all passing)

**Swift (211 tests):** 16 suites covering all models, WordPressClient, all storage layers, AIPromptBuilder, AnthropicClient, and AppState view-model logic. Each network suite uses its own MockURLProtocol subclass to avoid global-state races.
