...
## Test suite status (2026-08-20 — 365 Swift + 320 JS tests, all passing)

Counts verified by running each suite on 2026-08-20. If you touch a suite, re-run it and correct the number rather than trusting the prose below.
