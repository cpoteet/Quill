...
Runs everything — 435 Swift + 1,207 JS tests, all passing as of 2026-09-20 (1,206 JS pass and one is deliberately skipped; that skip is why this line reads one fewer than the total). Individual suites, what each one covers, the test-suite gotchas, and the manual release checklists: `docs/testing-plan.md`. If you touch a suite, re-run it and correct the counts there.
