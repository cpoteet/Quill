...
## Test suite status (2026-06-10 — 224 Swift + 57 JS tests, all passing)

**Swift (224 tests):** 17 suites covering all models, WordPressClient, all storage layers, AIPromptBuilder, AnthropicClient, AppState view-model logic, and EditorCoordinator. Each network suite uses its own MockURLProtocol subclass to avoid global-state races.
